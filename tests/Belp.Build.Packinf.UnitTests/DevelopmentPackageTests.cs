    ...
    public void Expect_package_to_be_pushed_and_cache_to_be_cleared()
    {
...

        {
            ...
            string packageCache = result.Properties
                ...
                .And.Subject
                ;
            Directory.Exists(Path.Combine(packageCache, "PushDevelopmentPackage", "1.0.0")).Should().BeTrue("Package should be restored and cached in global package cache");
        }

        {
            ...
            string packageCache = result.Properties
                ...
                .And.Subject
                ;
            Directory.Exists(Path.Combine(packageCache, "PushDevelopmentPackage", "1.0.0")).Should().BeFalse("Package should be wiped from global package cache");
        ...
        void AssertPackagesEqual()
        {
            ...
            GetHash("Debug/PushDevelopmentPackage.1.0.0.nupkg", hashOriginal);
            GetHash("packages/PushDevelopmentPackage.1.0.0.nupkg", hashNew);
